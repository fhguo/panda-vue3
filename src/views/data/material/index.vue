<template>
  <div class="container">
    ...
    <div class="header card">
      <el-form :inline="true" :model="formInline" ref="applyFormRef" class="form-inline">
        <div>
    ...
    <div class="content card card-1">
      <div class="content-header">
        <el-button type="primary" icon="CirclePlus" @click="addApply">新增物料</el-button>
      ...
      <el-table id="my-table" :data="tableData" style="width: 100%" border stripe
        ...
        <el-table-column property="code" label="院内码" width="80" />
        <el-table-column property="name" label="物料名称" show-overflow-tooltip />
        <el-table-column property="sName" label="简称" />
    ...
    <!-- 新增对话框 -->
    <el-dialog v-model="addFormVisible" title="新增物料">
      <el-form ref="addFormRef" :inline="true" :model="addForm" :rules="addRules" label-width="120px" class="add-ruleForm"
        status-icon>
        <el-form-item label="院内码" prop="name">
          <el-input v-model="addForm.name" placeholder="请输入院内码" />
        </el-form-item>
        <el-form-item label="物料名称" prop="name">
          <el-input v-model="addForm.name" placeholder="请输入物料名称" />
        </el-form-item>
        <el-form-item label="简称" prop="name">
          <el-input v-model="addForm.name" placeholder="请输入简称" />
        </el-form-item>
        <el-form-item label="品牌" prop="name">
          <el-input v-model="addForm.name" placeholder="请输入品牌" />
        </el-form-item>
        <el-form-item label="规格" prop="name">
          <el-input v-model="addForm.name" placeholder="请输入规格" />
        </el-form-item>
        <el-form-item label="单位" prop="name">
          <el-input v-model="addForm.name" placeholder="请输入单位" />
        </el-form-item>
...
const onReset = () => {
  console.log('onReset!')
  console.log(applyFormRef.value);
...
const tableData: reagentList[] = [
  ...
  },
  {
    ...
    sName: '糖化白蛋白',
    brand: '迈克生物',
    specification: 'GAR1 20ml GAR2 5ml*1',
    unit: '盒',
    status: false,
  },
  {
