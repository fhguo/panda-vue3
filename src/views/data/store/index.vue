  ...
  <div class="container">
    ...
    <div class="content card card-1">
      <div class="content-header">
        <el-button type="primary" icon="CirclePlus" @click="addApply">新增仓库</el-button>
      ...
      <el-table id="my-table" :data="tableData" style="width: 100%" border stripe
        ...
        <el-table-column property="classify" label="分类" width="120"/>
    ...
    <!-- 新增对话框 -->
    <el-dialog v-model="addFormVisible" title="新增仓库">
      <el-form ref="addFormRef" :inline="true" :model="addForm" :rules="addRules" label-width="120px" class="add-ruleForm"
        ...
        <el-form-item label="地址" prop="name">
          <el-input v-model="addForm.name" placeholder="请输入地址" />
        </el-form-item>
...
const tableData: reagentList[] = [
  {
    ...
    classify: '一级仓库',
    address: '浙江大学第一附属医院',
    desc: '我们正在寻找一名仓库工人，以帮助我们组织我们的仓库，以帮助组织订单，确保项目包装和发货及时',
    status: false,
  },
  {
    code: '10002',
  ...
  },
  {
    ...
    classify: '一级仓库',
    address: '浙江大学第一附属医院',
    desc: '帮助我们组织我们的仓库，以帮助组织订单，确保项目包装和发货及时',
    status: false,
  },
  {
    code: '10004',
